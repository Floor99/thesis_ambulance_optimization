...
def get_static_data_object(
    ...
    graph, G_pt = create_osmnx_sub_graph_only_inside_helmond(51.474744, 5.679176, dist = dist, timeseries_df=time_series)
    ...
    # fig.savefig('data/plots/mini_test.png', dpi=300)
