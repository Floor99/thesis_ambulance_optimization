...
from thesis_floor_halkes.train.mlflow_utils import log_agent_checkpoint, log_episode_artifacts, log_full_models, log_gradient_norms
...
with mlflow.start_run():
    ...
    for epoch in range(num_epochs):
        ...
        for graph_idx, static_data in enumerate(dataset):
            ...
            fig, _ = plot_with_route(env.static_data.G_sub, env.static_data.G_pt, route, goal_node=env.static_data.node_id_mapping[goal_node])
